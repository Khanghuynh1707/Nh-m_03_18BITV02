    ...
    <section class="content">
    	<form method="post" action="" class="form form-horizontal">
    		...
    		<div class="row" form-group>
    			...
    			<div class="col-md-3">
      				<input type="number" name="product_unit_price" class="form-control" placeholder="Unit_Price" min="0" step="10">
   				</div>
    			<div class="col-md-3">
    				<label>Promotion price</label>
    			</div>
    			<div class="col-md-3">
    				<input type="number" name="product_promotion_price" class="form-control" placeholder="Promotion_Price" min="0" step="10">
    			</div>
    		</div>
    		<div class="row" form-group>
    			<div class="col-md-3">
